...
- (void)configSelf
{
    ...
    _tabBgColor = kRGBA(235, 235, 235,1.0);
    _tabArrowBgColor = [UIColor orangeColor];
    _tabTitleColor = [UIColor grayColor];
    _tabSelectedBgColor = kRGBA(235, 235, 235,1.0);
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGRect frame;
    frame.origin.y = 30;
    frame.size.height = _scrollView.frame.size.height - 30;
    frame.size.width = rect.size.width;
    
    _pageControl = [[UIView alloc]initWithFrame:CGRectMake(0, 0, rect.size.width, 30)];
