...
//              titleStr = [NSString stringWithFormat:@"我正在我嗨直播直播看 【%@】的直播，一起来引爆弹幕吧",titleStr];
        ...
        case 52://微博
            ...
            titleStr = [NSString stringWithFormat:@"我正在我嗨直播直播看 【%@】的直播，一起来引爆弹幕吧！ 猛戳->>>%@(分享来自@ZWQYY)",titleStr,urlStr];
...
//            titleStr = [NSString stringWithFormat:@"我正在我嗨直播直播看 【%@】的直播，一起来引爆弹幕吧",titleStr];
        ...
        default:
            ...
            [self showWarning:@"程序未安装,请到App Store下载"];
            break;
    }
